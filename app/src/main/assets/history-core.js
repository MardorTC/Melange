...
(function (root) {
        ...
        try {
          if (e.kind === "debt" || e.kind === "fixed") {
            if (
              ...
              throw Error(
                "El mes del compromiso debe estar dentro del periodo.",
              );
  ...
  root.HistoryRebuild = { create, build, reconcile };
  if (typeof module !== "undefined") module.exports = root.HistoryRebuild;
})(globalThis);
